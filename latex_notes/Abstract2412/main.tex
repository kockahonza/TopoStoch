...
\begin{abstract}
	...
	In this study we look for topological features in a non-equilibrium, thermodynamically consistent stochastic model of an allosteric assembly where each subunit can change conformation and bind ligands.
	We consider systems where isolated subunits would undergo futile cycles of binding a ligand, changing conformation, debinding and changing conformation back to its original state.
