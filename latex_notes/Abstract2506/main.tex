...
\begin{abstract}
	...
	We find a set of simplest such systems and identify a one-to-one mapping between them and elementary cellular automata rules.
	Among these rules we find a rich set of behaviours, including multistability and dynamical steady states of various geometries including oscillators.
	Many restrict the available state-space of the complex into a set of stable states.
